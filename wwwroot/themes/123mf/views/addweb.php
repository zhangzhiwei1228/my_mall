...
<form method="post">
	<div class="n-addweb">
		...
		<table width="100%">
			...
			<tr>
				<td width="30%"><p>详细地址：</p></td>
				<td><textarea style="width:95%;float:none;" name="address" id="" cols="30" rows="10"><?=$this->data['address']?></textarea></td>
			</tr>
		</table>
	...
	seajs.use('/assets/js/validator/validator.sea.js', function(validator){
		validator('form', {
			rules: {
				...
				'[name=phone]': { valid: 'required|numeric|mobile', errorText: '请填写联系电话|请正确填写电话号码|手机号格式错误' }
			}
		});
	});
</script>
