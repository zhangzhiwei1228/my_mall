...
<!--				<img src="--><?php //echo static_file('m/img/pic17.png'); ?><!-- ">-->
	...
	<div style="margin-bottom:71px;" class="member-rank bgwhite">
		<a href="<?php echo $this->url('agent/logs/recharge')?>" ><p class="w90">商家本日赠送免费积分：<span style="font-size: 20px;color: #b40000;"><?php echo $this->employ['total'] ? $this->employ['total'] : 0 ?></span>（查看详情）</p></a>
		<a href="<?php echo $this->url('agent/logs/employ')?>" ><p class="w90">商家本日充值免费积分：<span style="font-size: 20px;color: #b40000;"><?php echo $this->recharge['total'] ? $this->recharge['total'] : 0?></span>（查看详情）</p></a>
