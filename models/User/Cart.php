...
class User_Cart extends Abstract_Model
{
	...
	public function price_type($cart) {
		...
		switch($cart['price_type']) {
			case 1 :
				$cart['price_text']['name'] =  '快乐积分';
				$cart['price_text']['value'] = $cart['point1'];
				//$cart['price_text'] = $cart['point1'] .'快乐积分';
				//$cart['final_credit_happy'] = $cart['point1'] ;
				break;
			case 2 :
				$cart['price_text']['name'] =  '帮帮币';
				$cart['price_text']['value'] = $cart['point2'];
				//$cart['price_text'] = $cart['point2'] .'帮帮币';
				//$cart['final_credit'] = $cart['point2'] ;
				break;
			case 3 :
				$cart['price_text']['name'] =  '积分币';
				$cart['price_text']['value'] = $cart['point3'];
				//$cart['price_text'] = $cart['point3'] .'积分币';
				//$cart['final_credit_coin'] = $cart['point3'] ;
				break;
			case 4 :
				$cart['price_text']['name'] =  '现金+帮帮币';
				$cart['price_text']['value'] = $cart['exts']->ext1->cash ."+" .$cart['exts']->ext1->point;
				...
				break;
			case 5 :
				$cart['price_text']['name'] =  '现金+积分币';
				$cart['price_text']['value'] = $cart['exts']->ext2->cash ."+" .$cart['exts']->ext2->point;
				...
				break;
			case 6 :
				$cart['price_text']['name'] =  '抵用券';
				$cart['price_text']['value'] = $cart['point4'];
				//$cart['price_text'] =  $cart['point4'].'抵用券';
				//$cart['final_vouchers'] = $cart['point4'];
				break;
			case 7 :
				$cart['price_text']['name'] =  '现金';
				$cart['price_text']['value'] = $cart['point5'];
				//$cart['price_text'] = $cart['point5'].'现金';
				//$cart['final_cash'] =  $cart['point5'];
				break;
			case 8 :
				$cart['price_text']['name'] =  '现金+抵用券';
				$cart['price_text']['value'] = $cart['exts']->ext3->cash ."+" .$cart['exts']->ext3->point;
