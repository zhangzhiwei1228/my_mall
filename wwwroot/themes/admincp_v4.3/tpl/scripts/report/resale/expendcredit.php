...
$this->head()->setTitle('会员消耗免费积分币统计');
...
<div class="row" style="margin-top: 20px;">
    <div class="col-sm-12">
        <div class="panel panel-default">
            <div class="panel-heading">会员消耗免费积分币统计</div>
            <div class="panel-body">
                <table width="100%" class="table table-striped" data-plugin="chk-group">
                    ...
                    <tbody>
                    <tr>
                        <td><?php echo $this->conversion_coins?></td>
                        <td><?php echo $this->exchange_coins*-1?></td>
                        <td><?php echo $this->conversion_coins + $this->exchange_coins*-1?></td>
                    </tr>
                    </tbody>
                </table>
            </div>
